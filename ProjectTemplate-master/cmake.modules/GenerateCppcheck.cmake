...
FUNCTION(GENERATE_CPPCHECK)
    ...
    IF(CPPCHECK_FOUND)
        ...
        set(multiValueArgs SOURCES INCLUDES ENABLE_IDS SUPPRESSION_FILE)
...
"
EXECUTE_PROCESS(COMMAND \"${CPPCHECK_EXECUTABLE}\" ${INCLUDE_ARGUMENTS} ${SUPPRESSION_ARGUMENT} ${SUPPRESSION_FILE} ${IDS_ARGUMENT} --force --enable=style --enable=performance --inline-suppr --xml ${SOURCE_ARGS}
...
"
        ...
        MESSAGE(STATUS "  Generating cppcheck target with name ${TARGET_NAME}. Result file at: ${CPPCHECK_REPORT_FILE}")
